...
(defun search-values (word)
    ...
    (loop for i from 0 to (1- (length word))
        do (setq valueEqual 0)
        do (when (equal (elt word i) " ")
            (setq valueEqual 1)
            )
        ...
        do (when (and (equal operatorFlag 0) (equal valueEqual 0))
